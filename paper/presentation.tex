...
\begin{frame}
  \frametitle{Resilient Overlay Networks\footcite{ron}}
  ...
  \item Several studies based on RON:
    ...
    \begin{itemize}
    \item Redundant multipath routing\footcite{andersen2003best}
  ...
  \item ``Biologically inspired'' multipath routing
    \footcite{leibnitz2006biologically}
    \note[item]{Another - biologically inspired. Choose strongest path as
      ...
      randomness.}
  \item mTCP \footcite{zhang2004transport}
...
\begin{frame}
  ...
  \item SOSR: Scalable One-hop Source Routing \footcite{gummadi2004improving}
